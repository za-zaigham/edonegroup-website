...
export function Footer() {
  return (
    <footer className="bg-[var(--color-navy)] text-white">
      <div className="container-x py-16 grid gap-12 md:grid-cols-4">
        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-5 flex gap-3">
            <a href="https://wa.me/447570985500" target="_blank" rel="noopener"
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            <li>
              <a href="mailto:info@edonegroup.com" className="hover:text-white transition">
                info@edonegroup.com
              </a>
            </li>
      ...
      <div className="border-t border-white/10">
        <div className="container-x py-5 text-xs text-white/50 leading-relaxed text-center md:text-left space-y-1">
          <div>
            EdOne Group Ltd · Company No. 17101141 · Registered in England and Wales · 163 Silverhill Drive, Newcastle upon Tyne, NE5 2JP
          </div>
          <div className="text-white/40">
            We work with UK universities both directly and via authorised partner channels. Reference to a university on this site does not imply an exclusive direct agreement.
          </div>
        </div>
      </div>
