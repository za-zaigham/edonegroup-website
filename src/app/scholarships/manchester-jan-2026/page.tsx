            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="p-6 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]">
                ...
                <p className="text-xs text-[var(--color-muted)] mb-5 leading-relaxed">
                  EdOne supports applications to the University of Manchester — we guide you through the process and help identify scholarship options that suit your profile. Applications are submitted via authorised partner channels where applicable; EdOne is not an exclusive direct agent of the University of Manchester.
                </p>
                <Link href="/apply"
